...
class Toast{
  ...
  static void show(String msg,BuildContext context,{
    int type = NORMAL,int duration = 1, int gravity = CENTER, Color backgroundColor = const Color(0xAA000000),
    Color textColor = Colors.white,double backgroundRadius = 5.0}){
    ToastView.dismiss();
...
class ToastView{
  ...
  static void createView(String msg,BuildContext context,int type,int duration,int gravity,Color background,Color textColor,double backgroundRadius) async{
    overlayState = Overlay.of(context);
    overlayEntry = OverlayEntry(builder: (BuildContext context)=>ToastWidget(
        widget: Container(
