package com.gdou.jianyue.Constants;
...
public class Constants {
    ...
    public static final String SP_KEY_PLAY_MODE = "sp_key_paly_mode";
    public static final String SP_KEY_CURRENT_INDEX = "sp_key_current_index";
    public static final String PLAY_MODE_ONE = "play_mode_one";
    public static final String PLAY_MODE_LOOP = "play_mode_loop";
